...
},
{
  ...
  },
  {
    ...
    answers:[
      ...
      { text: 'Puthanveettil Narayana Panicker', correct: false },
      { text: 'Prithvi Narayana Panicker', correct: false }
    ]
  },
  {
  question: 'The slogan of PN Panicker Organization is',
    answers:[
      { text: 'Grow and Read', correct: false },
      { text: ' Read and Succeed', correct: false },
      { text: 'Read and Grow', correct: true },
      { text: 'Succeed and Grow', correct: false }
    ]
  }
